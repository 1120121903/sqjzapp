package com.sys8.sqjzapp.common.design;
...
public class CommonShapeButton extends AppCompatButton {
     ...
     *渐变中间颜色
     */
    private int mCenterFirstColor =0;
    /**
     *渐变中间颜色
     */
    private int mCenterSecondColor =0;
    /**
     * 渐变方向
    ...
    private void init(Context context,AttributeSet attrs){
        ...
        mCenterFirstColor = typedArray.getColor(R.styleable.CommonShapeButton_csb_centerFirstColor,0xFFFFFFFF);
        mCenterSecondColor = typedArray.getColor(R.styleable.CommonShapeButton_csb_centerFirstColor,0xFFFFFFFF);
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        // 初始化normal状态
        // 渐变色
        if (mStartColor != 0xFFFFFFFF && mEndColor != 0xFFFFFFFF && mCenterFirstColor != 0xFFFFFFFF && mCenterSecondColor != 0xFFFFFFFF) {
            normalGradientDrawable.setColors(new int[]{mStartColor,mCenterFirstColor,mCenterSecondColor,mEndColor});
