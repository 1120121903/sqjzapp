...
public class LearningAudioDetailListItem {
    ...
    public LearningAudioDetailListItem(String title, String content, String updateTime, boolean isStuded, boolean isPass) {
        this.title = title;
