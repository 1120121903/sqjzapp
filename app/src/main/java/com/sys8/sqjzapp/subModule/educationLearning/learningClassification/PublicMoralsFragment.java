...
public class PublicMoralsFragment extends LearningClassificationBaseFragment {
    ...
    RecyclerView recyclerLearningeducationPagePublicMorals;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if(view ==null){
            view = inflater.inflate(R.layout.fragment_learning_conent_public_morals, container, false);
        }
    ...
    private void intRv() {
        recyclerLearningeducationPagePublicMorals.setLayoutManager(new LinearLayoutManager(view.getContext()));
    }

    private void getListData() {
        mData = DataSource.getLearningEducationPublicMoralsListData();
    }
    ...
    private void setupAdapter() {
        ...
        recyclerLearningeducationPagePublicMorals.setAdapter(adapter);
    }
